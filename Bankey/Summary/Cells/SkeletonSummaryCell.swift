//
//  SkeletonSummaryCell.swift
//  Bankey
//
//  Created by Bento, Cesar on 13/08/25.
//

import UIKit

extension SkeletonSummaryCell: SkeletonLoadable {}

class SkeletonSummaryCell: UITableViewCell {
